...
>(function AlertDialogOverlay({ className, ...props }, ref): React.ReactElement {
  return (
...
>(function AlertDialogContent({ className, ...props }, ref): React.ReactElement {
  return (
    <AlertDialogPortal>
      <AlertDialogOverlay />
...
>(function AlertDialogTitle({ className, ...props }, ref): React.ReactElement {
...
>(function AlertDialogDescription({ className, ...props }, ref): React.ReactElement {
...
>(function AlertDialogAction({ className, ...props }, ref): React.ReactElement {
...
>(function AlertDialogCancel({ className, ...props }, ref): React.ReactElement {
  return (
