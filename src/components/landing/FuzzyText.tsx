...
const FuzzyText: React.FC<FuzzyTextProps> = ({
  ...
  fontWeight = 900,
  fontFamily = 'inherit',
  // Use project brand foreground color (tailwind --foreground HSL variable)
  ...
  useEffect(() => {
    ...
    let glitchTimeoutId: any = 0;
    let glitchEndTimeoutId: any = 0;
    let clickTimeoutId: any = 0;
    ...
    const init = async () => {
      ...
      if (typeof fontSize === 'number') {
        ...
        temp.style.fontSize = fontSize as string;
      ...
      if (gradient && Array.isArray(gradient) && gradient.length >= 2) {
        ...
        offCtx.fillStyle = color as string;
      }
      ...
      if (enableHover) {
        ...
        canvas.addEventListener('touchmove', handleTouchMove, { passive: false } as any);
