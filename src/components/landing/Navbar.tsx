...
export default function Navbar({ onJoinWaitlistClick }: NavbarProps) {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-4 left-6 right-6 z-50 pointer-events-none"
    ...
    >
      ...
      <div className="fixed top-4 right-6 md:hidden z-50 pointer-events-auto">
        <button
          className="text-foreground cursor-pointer bg-transparent"
